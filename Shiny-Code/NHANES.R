...
# Mine's tutoial posted in tutorials


library(shiny)
library(sysfonts) # to add custom fonts
library(bslib)    # theme and styling
library(thematic) # theme
...
ui <- fluidPage(
  ...
  # run this code to find a theme first, then copy the code in the terminal and post above
  # bs_theme_preview(),
